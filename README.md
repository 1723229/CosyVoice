...
docker run -d --runtime=nvidia  -v /root/CosyVoice/pretrained_models:/models -p 50000:50000 cosyvoice:v1.0 /bin/bash -c "cd /opt/CosyVoice/CosyVoice/runtime/python/fastapi && python3 server.py --port 50000 --model_dir /models/CosyVoice-300M-25Hz /CosyVoice-300M-25Hz && sleep infinity"
```
